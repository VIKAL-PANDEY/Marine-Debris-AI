...
export default function App() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex flex-col bg-[#0A111E] text-[#FFFFFF] font-sans transition-colors selection:bg-[#1BDFC8] selection:text-[#0A111E]">
      ...
      <main className="flex-1 min-h-0 w-full relative overflow-hidden">
        ...
        {activeSection === 'cockpit' && (
          <div className="h-full w-full p-2 sm:p-2.5 flex flex-col lg:flex-row gap-2.5 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 flex flex-col bg-[#0F1A2C] border border-[#93A8BC]/25 rounded-lg overflow-hidden shadow-sm">
              {/* Stage Sub-Header Bar */}
              <div className="h-10 px-3 border-b border-[#93A8BC]/25 bg-[#142238] flex items-center justify-between gap-2 shrink-0">
                <div className="flex items-center gap-2 text-xs font-tech font-bold uppercase tracking-wider">
                  <span className="text-[#93A8BC]">TRANSECT:</span>
                  <span className="text-[#FFFFFF] truncate max-w-[200px] sm:max-w-[340px]">
                    {selectedFile ? selectedFile.name : result ? result.result_id : 'Awaiting Sonar Waterfall'}
                  </span>
                  {result && (
                    <span className="hidden sm:inline-block px-1.5 py-0.2 rounded bg-[#1BDFC8] text-[#0A111E] text-[10px] font-tech font-bold">
              ...
              <div className="flex-1 min-h-0 flex flex-col lg:flex-row gap-2 p-2 overflow-hidden bg-[#0A111E]">
            ...
            <div className="w-full lg:w-[380px] xl:w-[420px] h-full min-h-0 shrink-0 border border-[#93A8BC]/25 rounded-lg overflow-hidden shadow-sm bg-[#0F1A2C]">
              <CockpitTargetsPanel
                result={result}
                selectedDetectionId={selectedDetectionId}
                onSelectDetection={setSelectedDetectionId}
        ...
        {activeSection === 'ingest' && (
          <div className="h-full w-full p-4 sm:p-6 overflow-y-auto max-w-[1500px] mx-auto space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-[#93A8BC]/25">
              <div>
                <h2 className="text-base sm:text-lg font-tech font-bold uppercase tracking-wider text-[#FFFFFF] flex items-center gap-2">
                  <FolderUp className="w-5 h-5 text-[#1BDFC8]" />
              ...
              {result && (
                <button
                  ...
                  className="px-4 py-2 rounded-md bg-[#1BDFC8] hover:bg-[#1BDFC8]/90 text-[#0A111E] font-tech font-bold text-xs uppercase tracking-wider flex items-center gap-1.5 shadow-sm transition cursor-pointer self-start sm:self-auto"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-5 space-y-4">
                ...
                {processingStage !== 'idle' || isBatchRunning ? (
                  ...
                  <div className="bg-[#0F1A2C] border border-[#93A8BC]/25 rounded-lg p-4 font-sans text-xs shadow-sm">
                    <div className="flex items-center gap-2 text-[#FFFFFF] font-tech font-bold uppercase tracking-wider mb-1">
                      <Activity className="w-4 h-4 text-[#1BDFC8]" />
                      <span>HYDROGRAPHIC PIPELINE STANDBY</span>
                    </div>
                    <p className="text-[11px] text-[#93A8BC] leading-relaxed">
        ...
        {activeSection === 'analytics' && (
          <div className="h-full w-full p-4 sm:p-6 overflow-y-auto max-w-[1500px] mx-auto space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-[#93A8BC]/25">
              <div>
                <h2 className="text-base sm:text-lg font-tech font-bold uppercase tracking-wider text-[#FFFFFF] flex items-center gap-2">
                  <Activity className="w-5 h-5 text-[#1BDFC8]" />
              ...
              {result && (
                <button
                  ...
                  className="px-4 py-2 rounded-md bg-[#1BDFC8] hover:bg-[#1BDFC8]/90 text-[#0A111E] font-sans font-bold text-xs uppercase tracking-wider flex items-center gap-1.5 shadow-sm transition cursor-pointer self-start sm:self-auto"
                >
