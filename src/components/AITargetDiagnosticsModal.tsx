...
export const AITargetDiagnosticsModal: React.FC<AITargetDiagnosticsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-[#415111]/30 backdrop-blur-sm">
      <div className="bg-[#FEFEFE] border border-[#F2E8DF] rounded-lg max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl overflow-hidden font-sans text-[#415111]">
        {/* Modal Header */}
        <div className="p-3.5 border-b border-[#F2E8DF] bg-[#FEFEFE] flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs sm:text-sm font-tech font-bold text-[#415111] uppercase tracking-wider flex items-center gap-2">
                ...
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#D2E186] text-[#415111] border border-[#415111]/30 font-tech font-bold">
                  {target.id}
                </span>
              </h3>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={loading}
              className="p-1 rounded bg-[#F2E8DF] hover:bg-[#D2E186] border border-[#D2E186] text-[#415111] transition cursor-pointer text-xs font-bold"
              title="Refresh"
            >
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-3.5 text-xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 bg-[#F2E8DF] p-2.5 rounded border border-[#D2E186] text-[10px] font-sans">
            <div>
              <span className="text-[#415111]/70 font-medium block">Class:</span>
              <span className="font-tech font-bold text-[#415111] uppercase">
                {target.class_name.replace(/_/g, ' ')}
              </span>
            </div>
            <div>
              <span className="text-[#415111]/70 font-medium block">Confidence:</span>
              <span className="font-tech font-bold text-[#415111] tabular-nums">
                {(target.confidence * 100).toFixed(1)}%
              </span>
            </div>
            <div>
              <span className="text-[#415111]/70 font-medium block">Priority:</span>
              <span
            ...
            <div>
              <span className="text-[#415111]/70 font-medium block">Coordinates:</span>
              <span className="font-tech font-bold text-[#415111] tabular-nums">
          ...
          {loading ? (
            <div className="py-12 flex flex-col items-center justify-center gap-2.5">
              <Sparkles className="w-7 h-7 text-[#415111] animate-spin" />
              <p className="text-xs font-tech font-bold text-[#415111] uppercase tracking-wider">
                EXTRACTING ACOUSTIC SIGNATURE & BENTHIC ELEVATION...
              </p>
            </div>
          ) : error ? (
            <div className="p-3 bg-[#FB8159]/15 border border-[#FB8159]/40 rounded text-[#FB8159] text-[11px] font-sans font-semibold">
              {error}
            </div>
          ) : diagnostics ? (
            <>
              {/* Material Composition & Signature */}
              <div className="p-3 rounded bg-[#F2E8DF]/60 border border-[#D2E186] space-y-1">
                <span className="text-[10px] text-[#415111] font-tech font-bold uppercase tracking-wider flex items-center gap-1.5">
                  <Layers className="w-3.5 h-3.5 text-[#415111]" />
                  <span>MATERIAL & STRUCTURAL CLASSIFICATION</span>
                </span>
                <p className="text-[11px] text-[#415111] font-sans leading-relaxed">
              ...
              <div className="p-3 rounded bg-[#F2E8DF]/60 border border-[#D2E186] space-y-1">
                <span className="text-[10px] text-[#415111] font-tech font-bold uppercase tracking-wider flex items-center gap-1.5">
                  <Eye className="w-3.5 h-3.5 text-[#415111]" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-sans">
                <div className="p-2.5 rounded bg-[#FEFEFE] border border-[#D2E186]">
                  <span className="text-[#415111] font-tech font-bold block mb-1">
                    Mass & Submerged Buoyancy:
                  </span>
                  <p className="text-[#415111]/80">
              ...
              {/* Recovery Method */}
              <div className="p-3 rounded bg-[#F2E8DF] border border-[#D2E186] space-y-1">
                <span className="text-[10px] text-[#415111] font-tech font-bold uppercase tracking-wider flex items-center gap-1.5">
                  <Wrench className="w-3.5 h-3.5 text-[#415111]" />
              ...
              {diagnostics.safety_warnings && diagnostics.safety_warnings.length > 0 && (
                <div className="p-2.5 rounded bg-[#FB8159]/15 border border-[#FB8159]/40 space-y-1">
                  <span className="text-[10px] text-[#FB8159] font-tech font-bold uppercase tracking-wider flex items-center gap-1.5">
                    <ShieldAlert className="w-3.5 h-3.5 text-[#FB8159]" />
                    <span>OPERATIONAL HAZARD ADVISORIES</span>
                  </span>
                  <ul className="list-disc list-inside text-[10px] font-sans text-[#415111] space-y-0.5">
