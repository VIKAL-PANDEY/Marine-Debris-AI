...
export const DetectionPanel: React.FC<DetectionPanelProps> = ({
  ...
  const getDebrisIcon = (className: string) => {
    ...
    if (lower.includes('net') || lower.includes('ghost')) {
      return <Anchor className="w-3.5 h-3.5 text-[#1BDFC8]" />;
    }
    if (lower.includes('metal') || lower.includes('container')) {
      return <Box className="w-3.5 h-3.5 text-[#2E96DB]" />;
    }
    if (lower.includes('trap') || lower.includes('gear') || lower.includes('trawl')) {
      return <Layers className="w-3.5 h-3.5 text-[#93A8BC]" />;
    }
    if (lower.includes('plastic') || lower.includes('cargo')) {
      return <Trash2 className="w-3.5 h-3.5 text-[#1BDFC8]" />;
    }
    return <Crosshair className="w-3.5 h-3.5 text-[#2E96DB]" />;
  };
  ...
  const getPriorityBadge = (priority: DebrisPriority) => {
    switch (priority) {
      case 'high':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-tech font-bold uppercase tracking-wider bg-[#1BDFC8] text-[#0A111E] shadow-sm">
            <ShieldAlert className="w-3 h-3 text-[#0A111E]" />
            <span>CRITICAL</span>
          </span>
        );
      case 'medium':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-tech font-bold uppercase tracking-wider bg-[#2E96DB] text-[#FFFFFF]">
            <AlertCircle className="w-3 h-3 text-[#FFFFFF]" />
            <span>WARNING</span>
          </span>
        );
      case 'low':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-tech font-bold uppercase tracking-wider bg-[#142238] text-[#93A8BC] border border-[#93A8BC]/40">
  ...
  return (
    <div className="bg-[#0F1A2C] border border-[#93A8BC]/25 rounded-lg flex flex-col overflow-hidden shadow-sm font-sans transition-colors">
      {/* Panel Header */}
      <div className="p-3 border-b border-[#93A8BC]/25 bg-[#142238] flex flex-wrap items-center justify-between gap-2.5">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded bg-[#0B1320] border border-[#93A8BC]/30 flex items-center justify-center text-[#1BDFC8]">
            <Target className="w-4 h-4 text-[#1BDFC8]" />
          </div>
          <div>
            <h3 className="text-xs sm:text-sm font-tech font-bold uppercase tracking-wider text-[#FFFFFF] flex items-center gap-2">
              ...
              <span className="px-1.5 py-0.2 rounded bg-[#0B1320] text-[#1BDFC8] border border-[#93A8BC]/30 text-[10px] font-tech tabular-nums font-bold">
        ...
        <div className="flex items-center flex-wrap gap-2">
          <div className="hidden lg:flex items-center gap-1.5 bg-[#0B1320] border border-[#93A8BC]/25 rounded px-2 py-1 text-[10px] font-sans text-[#93A8BC]">
            <Keyboard className="w-3 h-3 text-[#1BDFC8]" />
            <span className="font-medium">Nav:</span>
            <kbd className="px-1 py-0.2 bg-[#142238] border border-[#93A8BC]/30 rounded text-[#FFFFFF] text-[9px] font-tech font-semibold">
              ↑ / ↓
            </kbd>
            <kbd className="px-1 py-0.2 bg-[#142238] border border-[#93A8BC]/30 rounded text-[#FFFFFF] text-[9px] font-tech font-semibold">
              C
          ...
          <div className="flex items-center bg-[#0B1320] border border-[#93A8BC]/25 rounded p-0.5 text-xs font-sans">
            <Filter className="w-3 h-3 text-[#1BDFC8] ml-1 mr-0.5" />
      ...
      <div className="flex items-center border-b border-[#93A8BC]/25 bg-[#0B1320] px-3 pt-2 gap-1 overflow-x-auto select-none">
        <button
          ...
          className={`px-3 py-1.5 text-xs font-tech font-bold uppercase tracking-wider border-b-2 transition whitespace-nowrap flex items-center gap-1.5 cursor-pointer ${
            activeTab === 'table'
              ? 'border-[#1BDFC8] text-[#1BDFC8] bg-[#0F1A2C] rounded-t'
              : 'border-transparent text-[#93A8BC] hover:text-[#FFFFFF]'
          }`}
        >
          <Target className="w-3.5 h-3.5" />
          <span>Detections Log</span>
          <span className="px-1 py-0.2 rounded bg-[#1BDFC8]/20 text-[#1BDFC8] text-[9px] tabular-nums font-bold">
            {filteredDetections.length}
          </span>
        </button>
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-tech font-bold uppercase tracking-wider border-b-2 transition whitespace-nowrap flex items-center gap-1.5 cursor-pointer ${
              activeTab === 'false_positives'
                ? 'border-[#2E96DB] text-[#2E96DB] bg-[#0F1A2C] rounded-t'
                : 'border-transparent text-[#2E96DB]/70 hover:text-[#2E96DB]'
            }`}
          >
            <AlertTriangle className="w-3.5 h-3.5 text-[#2E96DB]" />
            <span>Flagged False Positives</span>
            <span className="px-1 py-0.2 rounded bg-[#2E96DB] text-[#FFFFFF] text-[9px] tabular-nums font-bold">
      ...
      {selectedDetection && (
        <div className="px-3 py-2 bg-[#1BDFC8]/15 border-b border-[#1BDFC8]/30 flex flex-wrap items-center justify-between gap-2 animate-fadeIn">
          <div className="flex items-center gap-2 text-xs">
            <span className="w-2 h-2 rounded-full bg-[#1BDFC8] animate-ping" />
            <span className="font-tech font-bold uppercase tracking-wider text-[#1BDFC8]">
              FOCUSED TARGET: {selectedDetection.id}
            </span>
            <span className="text-[10px] text-[#93A8BC] font-medium">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            <button
              ...
              className="px-2.5 py-1 rounded bg-[#0F1A2C] border border-[#93A8BC]/30 text-[#FFFFFF] hover:border-[#1BDFC8] text-[10px] font-bold font-tech uppercase tracking-wider flex items-center gap-1 transition cursor-pointer shadow-sm"
              title="Copy GPS coordinates"
            >
              {copiedId === selectedDetection.id ? (
                <Check className="w-3 h-3 text-[#1BDFC8]" />
              ) : (
                <Copy className="w-3 h-3 text-[#93A8BC]" />
              )}
            ...
            {onOpenAICoPilot && (
              <button
                ...
                className="px-2.5 py-1 rounded bg-[#0F1A2C] border border-[#93A8BC]/30 text-[#FFFFFF] hover:bg-[#2E96DB]/25 text-[10px] font-bold font-tech uppercase tracking-wider flex items-center gap-1 transition cursor-pointer shadow-sm"
                title="Ask AI Co-Pilot about this target"
              >
                <MessageSquare className="w-3 h-3 text-[#2E96DB]" />
            ...
            {onOpenTargetDiagnostics && (
              <button
                ...
                className="px-2.5 py-1 rounded bg-[#0F1A2C] border border-[#93A8BC]/30 text-[#1BDFC8] hover:bg-[#1BDFC8]/20 text-[10px] font-bold font-tech uppercase tracking-wider flex items-center gap-1 transition cursor-pointer shadow-sm"
                title="Open deep acoustic diagnostics"
              >
                <Sparkles className="w-3 h-3 text-[#1BDFC8]" />
            ...
            {onMarkFalsePositive && (
              <button
                ...
                className="px-2.5 py-1 rounded bg-[#2E96DB]/20 hover:bg-[#2E96DB] text-[#2E96DB] hover:text-[#FFFFFF] border border-[#2E96DB] text-[10px] font-bold font-tech uppercase tracking-wider flex items-center gap-1 transition cursor-pointer shadow-sm"
            ...
            <button
              ...
              className="px-2 py-1 rounded text-[#93A8BC] hover:text-[#FFFFFF] text-[10px] font-bold font-tech uppercase tracking-wider flex items-center gap-1 transition cursor-pointer"
      ...
      {activeTab === 'table' && (
        <div className="overflow-x-auto max-h-[380px] overflow-y-auto">
          {filteredDetections.length === 0 ? (
            <div className="p-8 text-center text-xs font-sans text-[#93A8BC] flex flex-col items-center gap-2">
              <Target className="w-6 h-6 text-[#93A8BC]/40 mb-1" />
            ...
            <table className="w-full text-left text-xs font-sans border-collapse">
              <thead>
                <tr className="border-b border-[#93A8BC]/25 bg-[#142238] text-[#FFFFFF] text-[9px] uppercase tracking-wider sticky top-0 z-10 font-tech font-bold">
              ...
              <tbody className="divide-y divide-[#93A8BC]/15 text-[#93A8BC]">
                  ...
                  return (
                    <tr
                      ...
                      className={`transition-colors duration-150 cursor-pointer ${
                        isSelected
                          ? 'bg-[#1BDFC8]/15 border-l-4 border-l-[#1BDFC8] font-semibold'
                          : isEvenRow
                          ? 'bg-[#0F1A2C] hover:bg-[#2E96DB]/15'
                          : 'bg-[#142238]/60 hover:bg-[#2E96DB]/15'
                      }`}
                    >
                      {/* ID */}
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={`w-5 h-5 rounded text-[10px] flex items-center justify-center font-bold font-tech tabular-nums ${
                              isSelected
                                ? 'bg-[#1BDFC8] text-[#0A111E]'
                                : 'bg-[#0B1320] text-[#93A8BC] border border-[#93A8BC]/30'
                            }`}
                          >
                            {index + 1}
                          </span>
                          <Crosshair
                            className={`w-3.5 h-3.5 ${
                              isSelected ? 'text-[#1BDFC8] animate-spin' : 'text-[#93A8BC]/50'
                            }`}
                          />
                          <span className={`font-tech tabular-nums ${isSelected ? 'text-[#FFFFFF] font-bold' : 'font-semibold'}`}>
                            {det.id}
                          </span>
                          {isFalsePositive && (
                            <span className="px-1.5 py-0.2 rounded text-[8px] font-tech font-bold uppercase tracking-wider bg-[#2E96DB] text-[#FFFFFF]">
                              FP
                            </span>
                          )}
                        </div>
                      ...
                      <td className="py-2.5 px-3">
                        <div className="flex items-center gap-1.5">
                          <div className="p-1 rounded bg-[#0B1320] border border-[#93A8BC]/25">
                            {getDebrisIcon(det.class_name)}
                          </div>
                          <span className="capitalize font-semibold text-[#FFFFFF] font-sans">
                      ...
                      <td className="py-2.5 px-3">
                        <div className="flex items-center gap-2">
                          <div className="w-14 bg-[#0B1320] h-2 rounded-full overflow-hidden border border-[#93A8BC]/25">
                            <div
                              className="bg-[#1BDFC8] h-full rounded-full transition-all"
                              style={{ width: `${det.confidence * 100}%` }}
                            />
                          </div>
                          <span className="text-[11px] font-tech tabular-nums font-bold text-[#FFFFFF]">
                      ...
                      {/* Coordinates */}
                      <td className="py-2.5 px-3 text-[#93A8BC] text-[11px] font-tech tabular-nums font-medium">
                        ...
                        <div className="flex items-center justify-end gap-1" onClick={(e) => e.stopPropagation()}>
                          <button
                            ...
                            className={`p-1.5 rounded transition cursor-pointer ${
                              copiedId === det.id
                                ? 'bg-[#1BDFC8] text-[#0A111E]'
                                : 'hover:bg-[#142238] text-[#93A8BC] hover:text-[#FFFFFF]'
                            }`}
                            title="Copy GPS coordinates"
                          >
                            {copiedId === det.id ? (
                              <Check className="w-3.5 h-3.5 text-[#0A111E]" />
                            ) : (
                          ...
                          {onOpenAICoPilot && (
                            <button
                              ...
                              className="p-1.5 rounded hover:bg-[#142238] text-[#2E96DB] transition cursor-pointer"
                          ...
                          {onOpenTargetDiagnostics && (
                            <button
                              ...
                              className="p-1.5 rounded hover:bg-[#142238] text-[#1BDFC8] transition cursor-pointer"
                          ...
                          {onMarkFalsePositive && (
                            <button
                              ...
                              className="p-1.5 rounded hover:bg-[#142238] text-[#93A8BC] hover:text-[#2E96DB] transition cursor-pointer"
      ...
      {activeTab === 'coordinates' && (
        <div className="p-4 space-y-3">
          <div className="flex items-center justify-between">
            <div className="text-xs font-tech font-bold uppercase tracking-wider text-[#FFFFFF] flex items-center gap-1.5">
              <Compass className="w-4 h-4 text-[#1BDFC8]" />
              <span>Bathymetric Spatial Georeferencing</span>
            </div>
            <button
              onClick={handleCopyAllCoordinates}
              className="px-3 py-1 rounded bg-[#142238] hover:bg-[#2E96DB]/25 text-[#FFFFFF] border border-[#93A8BC]/30 text-[10px] font-tech font-bold uppercase tracking-wider flex items-center gap-1.5 transition cursor-pointer"
            >
              {copiedId === 'ALL' ? <Check className="w-3 h-3 text-[#1BDFC8]" /> : <Copy className="w-3 h-3" />}
              ...
              <div
                ...
                className={`p-3 rounded-lg border transition-all cursor-pointer ${
                  selectedDetectionId === det.id
                    ? 'bg-[#1BDFC8]/15 border-[#1BDFC8] shadow-sm'
                    : 'bg-[#142238] border-[#93A8BC]/25 hover:border-[#2E96DB]'
                }`}
              >
                <div className="flex items-center justify-between mb-1.5">
                  <span className="font-tech font-bold text-xs text-[#FFFFFF]">
                    {det.id}
                  </span>
                  {getPriorityBadge(det.priority)}
                </div>
                <div className="space-y-1 text-[11px] font-sans text-[#93A8BC]">
                  <div className="font-tech tabular-nums font-semibold text-[#FFFFFF]">
                    LAT: {det.latitude.toFixed(6)}° N
                  </div>
                  <div className="font-tech tabular-nums font-semibold text-[#FFFFFF]">
                    LON: {det.longitude.toFixed(6)}° E
                  </div>
                  <div className="text-[10px] text-[#93A8BC] pt-1 border-t border-[#93A8BC]/20 flex justify-between">
                    <span>Bounding Box: {det.bbox.width}×{det.bbox.height}px</span>
                    <button
                      onClick={(e) => handleCopyCoords(det, e)}
                      className="text-[#1BDFC8] font-bold font-tech hover:underline cursor-pointer"
                    >
      ...
      {activeTab === 'threat' && (
        <div className="p-4 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="p-3.5 rounded-lg bg-[#142238] border border-[#1BDFC8]/50 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-tech font-bold uppercase tracking-wider text-[#1BDFC8] flex items-center gap-1">
                  <ShieldAlert className="w-3.5 h-3.5" />
                  <span>Ghost Net Entanglement Risk</span>
                </span>
                <span className="text-[10px] font-tech font-bold text-[#1BDFC8]">CRITICAL</span>
              </div>
              <p className="text-[11px] leading-relaxed text-[#93A8BC]">
              ...
              <div className="text-[10px] font-tech font-bold text-[#1BDFC8]">
                Recommended Action: Deploy ROV cutter or winch retrieval.
              </div>
            </div>

            <div className="p-3.5 rounded-lg bg-[#142238] border border-[#2E96DB]/50 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-tech font-bold uppercase tracking-wider text-[#2E96DB] flex items-center gap-1">
                  <AlertCircle className="w-3.5 h-3.5 text-[#2E96DB]" />
                  <span>Benthic Habitat Degradation</span>
                </span>
                <span className="text-[10px] font-tech font-bold text-[#2E96DB]">WARNING</span>
              </div>
              <p className="text-[11px] leading-relaxed text-[#93A8BC]">
              ...
              <div className="text-[10px] font-tech font-bold text-[#2E96DB]">
                Recommended Action: Environmental monitoring & heavy grapple hoist.
              </div>
            </div>

            <div className="p-3.5 rounded-lg bg-[#142238] border border-[#93A8BC]/30 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-tech font-bold uppercase tracking-wider text-[#FFFFFF] flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#1BDFC8]" />
                  <span>Navigational Advisory</span>
                </span>
                <span className="text-[10px] font-tech font-bold text-[#93A8BC]">ADVISORY</span>
              </div>
              <p className="text-[11px] leading-relaxed text-[#93A8BC]">
              ...
              <div className="text-[10px] font-tech font-bold text-[#93A8BC]">
      ...
      {activeTab === 'false_positives' && (
        <div className="p-4 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-tech font-bold uppercase tracking-wider text-[#2E96DB] flex items-center gap-1.5">
          ...
          <div className="space-y-2">
            {falsePositiveIds.map((id) => {
              ...
              return (
                <div
                  key={id}
                  className="p-3 rounded-lg bg-[#142238] border border-[#2E96DB]/40 flex items-center justify-between text-xs"
                >
                  <div className="space-y-0.5">
                    <span className="font-tech font-bold text-[#FFFFFF]">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 rounded bg-[#0F1A2C] border border-[#2E96DB] text-[#2E96DB] text-[10px] font-tech font-bold uppercase tracking-wider hover:bg-[#2E96DB] hover:text-[#FFFFFF] transition cursor-pointer"
                  >
                    Unflag / Restore
                  </button>
                </div>
      ...
      {/* Footer Info */}
      <div className="p-2.5 border-t border-[#93A8BC]/25 bg-[#142238] flex items-center justify-between text-[10px] font-sans text-[#93A8BC]">
